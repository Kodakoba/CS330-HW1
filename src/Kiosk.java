...
public class Kiosk extends ShavedIceStore {
    public Kiosk() {
        System.out.println("Thank you for choosing the Shaved Ice Kiosk\n");
    }
    ...
    public void Order(){
        ...
        String tempOrderNumber = iceCreams.nextLine();
        currentOrder.setOrderNumber(Integer.parseInt(tempOrderNumber));
